...
const (
	EventService_CreateEvent_FullMethodName        = "/calendar.event.v1.EventService/CreateEvent"
	EventService_UpdateEvent_FullMethodName        = "/calendar.event.v1.EventService/UpdateEvent"
	EventService_DeleteEvent_FullMethodName        = "/calendar.event.v1.EventService/DeleteEvent"
	EventService_ListEventsForDay_FullMethodName   = "/calendar.event.v1.EventService/ListEventsForDay"
	EventService_ListEventsForWeek_FullMethodName  = "/calendar.event.v1.EventService/ListEventsForWeek"
	EventService_ListEventsForMonth_FullMethodName = "/calendar.event.v1.EventService/ListEventsForMonth"
)
...
func (c *eventServiceClient) ListEventsForDay(ctx context.Context, in *ListEventsRequest, opts ...grpc.CallOption) (*ListEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventService_ListEventsForDay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "calendar.event.v1.EventService",
